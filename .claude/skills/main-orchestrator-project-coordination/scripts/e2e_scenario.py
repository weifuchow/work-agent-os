...
Usage:
    python .claude/skills/main-orchestrator-project-coordination/scripts/e2e_scenario.py
    python .claude/skills/main-orchestrator-project-coordination/scripts/e2e_scenario.py --scenario a
    python .claude/skills/main-orchestrator-project-coordination/scripts/e2e_scenario.py --scenario b
...
DB_PATH = str(PROJECT_ROOT / "data" / "db" / "app.sqlite")
